        ...
        <div className="absolute inset-0 z-10 flex items-center justify-center">
          <div className="container mx-auto px-4 text-center">
            <div className="max-w-3xl mx-auto space-y-6 md:space-y-8 pt-12 md:pt-0">
              <h1 className="text-[15px] sm:text-[15px] md:text-[15px] lg:text-[15px] font-light text-white tracking-wide">
                你的温柔，自有力量
              </h1>
              ...
              <div className="flex flex-row gap-3 justify-center pt-4">
                <Link
                  href="/brand-story"
                  className="inline-flex items-center px-4 py-2 bg-white text-gray-900 text-[10px] font-medium hover:bg-gray-100 transition-colors"
                >
                  品牌故事
                ...
                <Link
                  href="/products"
                  className="inline-flex items-center px-4 py-2 border border-white text-white text-[10px] font-medium hover:bg-white/10 transition-colors"
                >
                  浏览产品
                </Link>
              </div>
